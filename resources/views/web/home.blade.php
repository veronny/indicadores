        ...
        <div class="card mb-4 shadow-sm text-center">
            <img src="{{ url('img/vacuna_covid.jpg') }}" class="card-img-top">
                <div class="card-body">
                    ...
                    <a href="https://radiant-sands-49815.herokuapp.com/" class="btn btn-success" target="_blank">Ver mas</a>
                </div>
        </div>
    </div>
            ...
            <div class="card mb-4 shadow-sm text-center">
                <img src="{{ url('img/hechos_vitales.png') }}" class="card-img-top">
                    <div class="card-body">
                        ...
                        <a href="{{ route('vitales') }}" class="btn btn-success" target="_blank">Ver mas</a>
                    </div>
            </div>
        </div>
